...
const items: React.ReactNode[] = [
  ...
  <React.Fragment key="4"><a href="">Low, fixed rates</a></React.Fragment>,
  <React.Fragment key="5">Flexible payment options - <em className="tw-italic">Up to 180 months</em></React.Fragment>,
