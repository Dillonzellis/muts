    ...
    >
      <ContentHeaderWrapper>
        ...
        <ContentSecondaryHeading
          italic
          title="24/7 Access enables life without interruptions!"
        />
      </ContentHeaderWrapper>
      <ContentTertHeader label="Online & Mobile Banking" />
      <List liItems={remoteItems} />
      <div className="tw-text-lg tw-space-y-2">
        <strong>Bill Pay Member Service</strong>:{" "}
        <LinkText label="844.596.1874" href="tel:+1844-596-1874" /> between 7:00
        AM - 1:00 AM ET, 7 days a week
        <div>
          <strong>PopMoney Support</strong>:{" "}
          <LinkText label="866.820.9920" href="tel:+1866-820-9920" /> (option 2)
        </div>
      </div>
      <div className="tw-text-lg">
        <strong>Enroll in online banking</strong> and download our mobile app
        (Search “Mutual Savings Credit Union”) today to get access on all your
        devices!
      </div>
      <div className="tw-flex tw-items-center tw-justify-center tw-gap-4">
        <a href="">
          <img
            className="tw-w-full tw-max-w-[167px]"
            src="http://dev2.growthbydesign.org/wp-content/uploads/app-store-logo.png"
          />
        </a>
        <a href="">
          <img
            className="tw-w-full tw-max-w-[167px] tw-rounded-2xl"
            src="http://dev2.growthbydesign.org/wp-content/uploads/Google-Play-Emblema.png"
          />
        </a>
      </div>
      <div>
        <em>
          To locate the MSCU mobile app, search for “Mutual Savings Credit Union
          Atlanta.”
        </em>
      </div>
      ...
      <ButtonWrapper>
        <Button btnText="ATM Locator" link="/#wow-modal-id-1" />
        <Button btnText="Shared Branching " link="/#wow-modal-id-11" />
      </ButtonWrapper>
      <LinkText label="Audio Response 800.835.2815" href="tel:+1800-835-2815" />
    </InnerContent>
  );
};
